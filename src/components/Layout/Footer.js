        ...
        <div className="container text-center text-md-start mt-5">
          <div className="row mt-3">
            ...
            <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4 list-unstyled ">
              ...
              />
              <p>
                <a href="/category/men-collections" className="text-white">
                  Men Collections
                </a>
              </p>
              <p>
                <a href="/category/woman-collections" className="text-white">
                  Women Collections
                </a>
              </p>
              <p>
                <a
                  href="/category/headphones-and-headsets"
              ...
              <p>
                <a href="/category/footwears" className="text-white">
                  Footwear
                </a>
              </p>
            </div>
            ...
            <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
              ...
              />
              <p>
                <i className="fas fa-home mr-3" /> Lorem ipsum dolor sit.
              </p>
              <p>
